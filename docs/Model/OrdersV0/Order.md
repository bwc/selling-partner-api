...
**order_total** | [**\SellingPartnerApiV5\Model\OrdersV0\Money**](Money.md) |  | [optional]
...
**payment_execution_detail** | [**\SellingPartnerApiV5\Model\OrdersV0\PaymentExecutionDetailItem[]**](PaymentExecutionDetailItem.md) | A list of payment execution detail items. | [optional]
...
**easy_ship_shipment_status** | [**\SellingPartnerApiV5\Model\OrdersV0\EasyShipShipmentStatus**](EasyShipShipmentStatus.md) |  | [optional]
...
**default_ship_from_location_address** | [**\SellingPartnerApiV5\Model\OrdersV0\Address**](Address.md) |  | [optional]
**buyer_invoice_preference** | **string** | The buyer's invoicing preference. Available only in the TR marketplace. | [optional]
**buyer_tax_information** | [**\SellingPartnerApiV5\Model\OrdersV0\BuyerTaxInformation**](BuyerTaxInformation.md) |  | [optional]
**fulfillment_instruction** | [**\SellingPartnerApiV5\Model\OrdersV0\FulfillmentInstruction**](FulfillmentInstruction.md) |  | [optional]
...
**marketplace_tax_info** | [**\SellingPartnerApiV5\Model\OrdersV0\MarketplaceTaxInfo**](MarketplaceTaxInfo.md) |  | [optional]
...
**buyer_info** | [**\SellingPartnerApiV5\Model\OrdersV0\BuyerInfo**](BuyerInfo.md) |  | [optional]
**automated_shipping_settings** | [**\SellingPartnerApiV5\Model\OrdersV0\AutomatedShippingSettings**](AutomatedShippingSettings.md) |  | [optional]
...
**electronic_invoice_status** | [**\SellingPartnerApiV5\Model\OrdersV0\ElectronicInvoiceStatus**](ElectronicInvoiceStatus.md) |  | [optional]
