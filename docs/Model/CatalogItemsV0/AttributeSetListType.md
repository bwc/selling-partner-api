...
**cpu_speed** | [**\SellingPartnerApiV5\Model\CatalogItemsV0\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional]
**cpu_type** | **string** | The CPU type attribute of the item. | [optional]
**creator** | [**\SellingPartnerApiV5\Model\CatalogItemsV0\CreatorType[]**](CreatorType.md) | The creator attributes of the item. | [optional]
...
**display_size** | [**\SellingPartnerApiV5\Model\CatalogItemsV0\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional]
...
**hard_disk_size** | [**\SellingPartnerApiV5\Model\CatalogItemsV0\DecimalWithUnits**](DecimalWithUnits.md) |  | [optional]
...
**languages** | [**\SellingPartnerApiV5\Model\CatalogItemsV0\LanguageType[]**](LanguageType.md) | The languages attribute of the item. | [optional]
**legal_disclaimer** | **string** | The legal disclaimer attribute of the item. | [optional]
**list_price** | [**\SellingPartnerApiV5\Model\CatalogItemsV0\Price**](Price.md) |  | [optional]
