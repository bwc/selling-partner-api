...
class VendorDirectFulfillmentOrdersV1Api extends BaseApi
{
     ...
     * @return \SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\GetOrderResponse
     */
     ...
     * @throws \SellingPartnerApiV5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\GetOrderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderWithHttpInfo($purchase_order_number)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\GetOrderResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\GetOrderResponse', $response->getHeaders());
                case 400:
                    if ('\SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\GetOrderResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\GetOrderResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\GetOrderResponse',
     ...
     * @throws \SellingPartnerApiV5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\GetOrdersResponse
     */
     ...
     * @throws \SellingPartnerApiV5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\GetOrdersResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrdersWithHttpInfo($created_after, $created_before, $ship_from_party_id = null, $status = null, $limit = null, $sort_order = null, $next_token = null, $include_details = 'true')
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\GetOrdersResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\GetOrdersResponse', $response->getHeaders());
                case 400:
                    if ('\SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\GetOrdersResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\GetOrdersResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\GetOrdersResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\SubmitAcknowledgementRequest $body body (required)
     *
     * @throws \SellingPartnerApiV5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\SubmitAcknowledgementResponse
     */
     ...
     *
     * @param  \SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\SubmitAcknowledgementRequest $body (required)
     *
     * @throws \SellingPartnerApiV5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\SubmitAcknowledgementResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitAcknowledgementWithHttpInfo($body)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 202:
                    if ('\SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\SubmitAcknowledgementResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\SubmitAcknowledgementResponse', $response->getHeaders());
                case 400:
                    if ('\SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\SubmitAcknowledgementResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\SubmitAcknowledgementResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\SubmitAcknowledgementResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
