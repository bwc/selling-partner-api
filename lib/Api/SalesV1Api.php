...
class SalesV1Api extends BaseApi
{
     ...
     * @return \SellingPartnerApiV5\Model\SalesV1\GetOrderMetricsResponse
     */
     ...
     * @throws \SellingPartnerApiV5\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SellingPartnerApiV5\Model\SalesV1\GetOrderMetricsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderMetricsWithHttpInfo($marketplace_ids, $interval, $granularity, $granularity_time_zone = null, $buyer_type = 'All', $fulfillment_network = null, $first_day_of_week = 'monday', $asin = null, $sku = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SellingPartnerApiV5\Model\SalesV1\GetOrderMetricsResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }

                    return ObjectSerializer::deserialize($content, '\SellingPartnerApiV5\Model\SalesV1\GetOrderMetricsResponse', $response->getHeaders());
                case 400:
                    if ('\SellingPartnerApiV5\Model\SalesV1\GetOrderMetricsResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
            ...
            $returnType = '\SellingPartnerApiV5\Model\SalesV1\GetOrderMetricsResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SellingPartnerApiV5\Model\SalesV1\GetOrderMetricsResponse',
