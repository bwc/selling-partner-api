...
class AllowanceDetails extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'type' => 'string',
        'description' => 'string',
        'allowance_amount' => '\SellingPartnerApiV5\Model\VendorInvoicesV1\Money',
     ...
     *
     * @param \SellingPartnerApiV5\Model\VendorInvoicesV1\Money $allowance_amount allowance_amount
     *
     * @return self
     */
     ...
     * Sets tax_details
     *
     * @param \SellingPartnerApiV5\Model\VendorInvoicesV1\TaxDetails[]|null $tax_details Tax amount details applied on this allowance.
     *
     * @return self
     */
