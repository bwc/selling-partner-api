...
class ListingsItemPatchRequest extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'product_type' => 'string',
        'patches' => '\SellingPartnerApiV5\Model\ListingsV20210801\PatchOperation[]'
    ];
     ...
     * Gets patches
     *
     * @return \SellingPartnerApiV5\Model\ListingsV20210801\PatchOperation[]
     */
     ...
     * Sets patches
     *
     * @param \SellingPartnerApiV5\Model\ListingsV20210801\PatchOperation[] $patches One or more JSON Patch operations to perform on the listings item.
     *
     * @return self
     */
