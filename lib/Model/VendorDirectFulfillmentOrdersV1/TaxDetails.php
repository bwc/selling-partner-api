...
class TaxDetails extends BaseModel implements ModelInterface, ArrayAccess, \JsonSerializable, \IteratorAggregate
{
    ...
    protected static $openAPITypes = [
        'tax_rate' => 'string',
        'tax_amount' => '\SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\Money',
        'taxable_amount' => '\SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\Money',
        'type' => 'string'
    ];
     ...
     * Sets tax_amount
     *
     * @param \SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\Money $tax_amount tax_amount
     *
     * @return self
     */
     ...
     * Sets taxable_amount
     *
     * @param \SellingPartnerApiV5\Model\VendorDirectFulfillmentOrdersV1\Money|null $taxable_amount taxable_amount
     *
     * @return self
     */
